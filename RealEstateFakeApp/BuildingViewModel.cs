...
namespace RealEstateFakeApp
{
    public class BuildingViewModel
    {
        ...
        public BuildingViewModel()
        {
            ...
            buildingCollection.Add(new Building { Picture = "room", Status = "Premium", StatusColor = Color.FromArgb("#ffa654"), Price = "$449,990", Description = "Exclusive, serviced, all bills included. City View", Beds = "2 beds", Bath = "2 baths", Sqfts = "150 sqfts", BuildingType = "Villa" });
